...
public class SearchAsendingOrderMatrix {
	...
	private Cord findHelper(int[][] matrix, int target, Cord leftTop, Cord rightBottom){
		...
		//System.out.println(leftTop.row);
		//System.out.println(leftTop.col);
		...
		Cord pivot = start;
		//System.out.println("pivot row = " + pivot.row);
		//System.out.println("pivot col = " + pivot.col);
